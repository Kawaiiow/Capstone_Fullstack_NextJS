      ...
      <div className="flex gap-2">
        {user ? (
          <details className="relative group">
            <summary className="list-none [&::-webkit-details-marker]:hidden cursor-pointer text-sm px-4 py-2 border border-border text-navy rounded flex items-center gap-1.5 focus:outline-none select-none">
