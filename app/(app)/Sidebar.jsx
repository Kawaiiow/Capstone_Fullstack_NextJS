    ...
    >
      ...
      <div className="flex flex-col gap-2">
        <a
          ...
          className={`px-4 py-2 rounded-lg text-navy/60 hover:bg-navy/60 hover:text-white ${
            expanded ? "" : "flex justify-center"
          }`}
        >
          {expanded ? "settings" : "S"}
        ...
        <button
          ...
          className={`text-left px-4 py-2 text-rose-600 rounded-lg hover:bg-rose-600 hover:text-white cursor-pointer font-medium transition-colors ${
